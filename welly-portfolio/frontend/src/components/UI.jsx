  ...
  return (
    <Reveal>
      <div style={{ textAlign: "center", marginBottom: 56 }}>
        <h2 style={{ fontFamily: "'Gibed', serif", fontSize: 40, fontWeight: 700, color: "#1a1a1a" }}>{title}</h2>
  ...
  return (
    <div style={{ textAlign: "center" }}>
      <svg width="190" height="190">
        ...
        <text x="95" y="100" textAnchor="middle" fontSize="18" fontFamily="'Gibed', serif" fill="#333">{pct}%</text>
      </svg>
      <p style={{ fontWeight: 700, fontSize: 18, fontFamily: "'Gibed', serif", marginTop: 4 }}>{name}</p>
    </div>
  );
}
...
export const inputStyle = {
  ...
  fontSize: 14, fontFamily: "'Gibed', serif", outline: "none",
};
