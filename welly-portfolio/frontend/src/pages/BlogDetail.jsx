...
export default function BlogDetail() {
  ...
  if (error) return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', sans-serif", background: "#e8e6e1" }}>
  ...
  if (!blog) return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', sans-serif", background: "#e8e6e1", color: "#888" }}>Loading...</div>
  );

  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#e8e6e1", minHeight: "100vh" }}>
      <style>{`
        .prose{max-width:720px;margin:0 auto;line-height:1.8;color:#333}
        .prose h1,.prose h2,.prose h3{font-family:'DM Serif Display',serif;color:#1a1a1a;margin:32px 0 16px}
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "60px 40px" }}>
        ...
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "clamp(28px, 4vw, 48px)", lineHeight: 1.2, marginBottom: 48, color: "#1a1a1a" }}>{blog.title}</h1>
          <div className="prose">
