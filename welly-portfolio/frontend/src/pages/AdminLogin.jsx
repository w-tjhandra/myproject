...
export default function AdminLogin() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#1a1a1a", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Gibed', serif" }}>
      <div style={{ background: "#fff", padding: 40, borderRadius: 8, width: 360, boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <span style={{ fontFamily: "'Gibed', serif", fontSize: 36, fontWeight: 700 }}>Welly</span>
