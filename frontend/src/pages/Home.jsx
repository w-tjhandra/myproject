    ...
    <div style={{ fontFamily: "'Nature', serif", background: "#e8e6e1", color: "#1a1a1a" }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .hero-grid{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:40px;text-align:center;}
      ...
      <section id="home" style={{ padding: 0, minHeight: "100vh", display: "flex", alignItems: "center", ...TEXTURE, backgroundSize: "300px", position: "relative" }}>
        <div className="inner hero-grid" style={{ paddingTop: "clamp(60px, 10vw, 100px)", paddingBottom: "clamp(30px, 5vw, 60px)", width: "100%" }}>
          <div style={{ animation: "fadeDown 0.8s ease both", display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", margin: "clamp(16px, 4vw, 32px) 0 clamp(16px, 4vw, 36px)" }}>
